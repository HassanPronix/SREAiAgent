...
const consumer = new ConsumerService('raw-log-group');
...
export async function startRawLogConsumer() {
  try {
    ...
    await consumer.subscribe([TOPICS.RAW_LOGS]);
        ...
        logger.debug(
          {
            ...
            metadata: {
              ...
              source: payload.service || payload.container || payload.tag || 'unknown',
        ...
        logger.error(
          {
            ...
            metadata: {
              ...
              incidentType: 'RAW_LOG_PROCESSING_FAILURE',
    ...
    logger.fatal(
      {
        ...
        metadata: {
          ...
          incidentType: 'RAW_LOG_CONSUMER_START_FAILURE',
